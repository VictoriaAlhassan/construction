  ...
  <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0">
        ...
        <p class="mt-6 text-lg leading-8 text-gray-300">We are a team of skilled professionals dedicated to providing high-quality construction services to our clients. With years of experience in the industry, we pride ourselves on delivering top-notch results that exceed our clients' expectations.
                                                       At our construction company, we specialize in a wide range of services, including residential and commercial construction, remodeling, renovations, and more. We are committed to providing exceptional craftsmanship, attention to detail, and excellent customer service.</p>
      </div>
