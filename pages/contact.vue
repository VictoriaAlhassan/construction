    ...
    <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
      <div class="relative px-6 pt-14 lg:static lg:px-8">
        ...
        >
          ...
          <div>
            <img src="/shahousingceo.jpg" alt="CEO of sha Housing" />
          </div>
          ...
          <dl class="mt-10 space-y-4 text-base leading-7 text-gray-300">
            ...
            <div class="flex gap-x-4">
              ...
              <dd>
                <a class="hover:text-white" href="tel:+233 242544821"
                  >0242544821<br />0553390759</a
                >
              </dd>
            </div>
            <div class="flex gap-x-4">
              ...
              <dd>
                <a
                  ...
                  href="mailto:sagbornitor10@gmail.com"
                  >sagbornitor10@gmail.com</a
                >
              </dd>
            </div>
          </dl>
